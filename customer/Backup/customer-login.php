...
<!-- ==================================================================
  ...
  [SIM] front-end mockup — no real auth; valid input redirects to the
  booking landing. Replace the script with PHP session auth later.
  ================================================================== -->
<html lang="en">
  <head>
...
<meta name="color-scheme" content="light">
  ...
  <body class="customer-login-page">
    <main class="login-page">
      <section class="login-shell" aria-labelledby="customerLoginTitle">
        <div class="auth-card">
          ...
          <form id="customerLoginForm" action="" method="post" novalidate data-auth-form="login" data-redirect="venusep_venue_booking.php" data-success-target="loginSuccessMessage" data-success-message="Login successful. Redirecting...">
    ...
    <!-- [SIM] front-end validation + fake redirect. Replace with PHP session auth later. -->
    <script>
      document.addEventListener('DOMContentLoaded', function () {
        ...
        document.querySelectorAll('[data-auth-form]').forEach(function (form) {
          ...
          form.addEventListener('submit', function (event) {
            ...
            // TODO: replace with real PHP authentication.
